...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 06 Oca 2022, 13:02:28
...
(0, 'dimg/30369fav-white.png', 'E-Ticaret projesi', 'Tavil Shop E-ticaret projesi', 'eticaret,shopping,php,', 'Tavil Shop', '+90 555 555 55 58', '+90 555 555 55 55', '+90 555 555 55 55', 'livatibrahim98@gmail.com', 'EFELER', 'AYDIN', 'Zafer, Aydın Adnan Menderes Üniversitesi Merkez Kampüs, 09010 Efeler/Aydın', '7 x 24 Açık E-ticaret Scripti', '', '', '', 'www.facebook.com', 'www.twitter.com', 'www.google.com', 'www.youtube.com', 'mail.alanadiniz.com', 'user', 'password', '467', '1');
...
CREATE TABLE `banka` (
  ...
  `banka_ad` varchar(50) CHARACTER SET utf8 NOT NULL,
  `banka_iban` varchar(50) CHARACTER SET utf8 NOT NULL,
  `banka_hesapadsoyad` varchar(50) CHARACTER SET utf8 NOT NULL,
  `banka_durum` enum('0','1') CHARACTER SET utf8 NOT NULL DEFAULT '0'
...
(1, 'Garanti Bankası', 'TR98755656564564546', 'İbrahim TAVİL', '1'),
(2, 'Yapı Kredi', 'TR45646545646545646465546', 'İbrahim TAVİL', '1'),
(3, 'Vakıfbank', 'TR455645645646546465465', 'İbrahim TAVİL', '1'),
(5, 'Ziraat Bankası', 'TR4564654564645646546', 'İbrahim TAVİL', '1');
...
CREATE TABLE `hakkimizda` (
  ...
  `hakkimizda_icerik` mediumtext NOT NULL,
...
CREATE TABLE `kullanici` (
  ...
  `kullanici_zaman` datetime NOT NULL DEFAULT '2021-12-09 18:07:00' ON UPDATE current_timestamp(),
  `kullanici_resim` varchar(250) CHARACTER SET utf8 NOT NULL,
  `kullanici_tc` varchar(50) CHARACTER SET utf8 NOT NULL,
  `kullanici_ad` varchar(50) CHARACTER SET utf8 NOT NULL,
  `kullanici_mail` varchar(100) CHARACTER SET utf8 NOT NULL,
  `kullanici_gsm` varchar(50) CHARACTER SET utf8 NOT NULL,
  `kullanici_password` varchar(50) CHARACTER SET utf8 NOT NULL,
  `kullanici_adsoyad` varchar(50) CHARACTER SET utf8 NOT NULL,
  `kullanici_adres` varchar(250) CHARACTER SET utf8 NOT NULL,
  `kullanici_il` varchar(100) CHARACTER SET utf8 NOT NULL,
  `kullanici_ilce` varchar(100) CHARACTER SET utf8 NOT NULL,
  `kullanici_unvan` varchar(100) CHARACTER SET utf8 NOT NULL,
  `kullanici_yetki` varchar(50) CHARACTER SET utf8 NOT NULL,
...
(147, '2021-12-09 18:59:26', '', '12345678910', '', 'tavil', '08508408076', '123', 'İBRAHİM TAVİL', '', '', '', '', '5', 1),
(154, '2022-01-02 00:54:08', '', '', '', 'livatibrahim98@gmail.com', '', 'e10adc3949ba59abbe56e057f20f883e', 'tavil', '', '', '', '', '1', 1);
...
(750013, '2021-12-09 16:09:35', NULL, 154, 95.00, 'Banka Havalesi', 'Vakıfbank', '0'),
(750014, '2021-12-17 16:09:30', NULL, 154, 190.00, 'Banka Havalesi', 'Garanti Bankası', '0'),
(750015, '2021-12-30 13:44:54', NULL, 154, 50.00, 'Banka Havalesi', 'Garanti Bankası', '0'),
(750016, '2021-12-30 13:51:45', NULL, 154, 100.00, 'Banka Havalesi', 'Garanti Bankası', '0'),
(750017, '2021-12-30 14:52:16', NULL, 154, 195.00, 'Banka Havalesi', 'Vakıfbank', '0'),
(750018, '2021-12-30 15:47:21', NULL, 154, 95.00, 'Banka Havalesi', 'Ziraat Bankası', '0'),
(750019, '2022-01-01 21:54:30', NULL, 154, 400.00, 'Banka Havalesi', 'Vakıfbank', '0');
...
(12, 750012, 5, 95.00, 1),
(13, 750013, 8, 95.00, 1),
(14, 750014, 14, 95.00, 1),
(15, 750014, 14, 95.00, 1),
(16, 750015, 18, 50.00, 1),
(17, 750016, 18, 50.00, 1),
(18, 750016, 18, 50.00, 1),
(19, 750017, 8, 95.00, 1),
(20, 750017, 18, 50.00, 2),
(21, 750018, 14, 95.00, 1),
(22, 750019, 15, 400.00, 1);
...
(2, 'Denim Ceket', 'dimg/slider/3067331362252582652425762274502674026403slide-1.jpg', 12, '', '1'),
(4, 'Kırmızı Şişme Mont ', 'dimg/slider/29538315172733129852slide-2.jpg', 2, '', '1'),
(5, 'Nike Spor Ayakkabı', 'dimg/slider/23243301742266520059slide-3.jpg', 3, '', '1'),
(6, 'Aksesuar Yüzük', 'dimg/slider/27613272132172620462slide-4.jpg', 4, '', '1');
...
(0, 0, 'dimg/urun/24100308002890124963S6804A2_20WN_RD79_01_01.jpg', 0),
...
--
ALTER TABLE `siparis_detay`
  MODIFY `siparisdetay_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
